...
conferencia_oeste = ('Denver Nuggets','Minnesota Timberwolves','Oklahoma City Thunder','Portland Trail Blazers','Utah Jazz',
                     'Dallas Mavericks','Houston Rockets','Memphis Grizzlies','New Orleans Pelicans','San Antonio Spurs',
                     'Golden State Warriors','Los Angeles Clippers','Los Angeles Lakers','Phoenix Suns','Sacramento Kings')


condicion_oeste = df_jugadores_roster['TEAM_NAME'].isin(conferencia_oeste)

df_oeste = df_jugadores_roster[condicion_oeste]

lista_df = []


#Usamos el _ para indicar que hay una variable, el indice de la tupla que devuelve el iterrows(), pero que no es importante
for _,jugador in df_oeste.iterrows():
...
if lista_df:
    ...
    df_datos_historicos.to_csv('nba_predictor/data/data_api/Estadisticas_Temporada_Regular_Jugadores_Actuales/estadisticas_jugadores_oeste.csv')
else:
